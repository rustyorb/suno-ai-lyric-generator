...
const getEnvVar = (key: string) => {
  // In client components, we need to access NEXT_PUBLIC_ variables directly
  if (typeof window !== "undefined") {
    // @ts-ignore - Next.js injects env variables at build time
    return (
      window.__NEXT_DATA__.props.pageProps.env?.[key] || process.env[key] || ""
    );
  }
  return "";
};
