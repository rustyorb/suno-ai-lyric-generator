      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-xl mb-6">
          ...
          <button
            ...
            className={`w-full py-3 rounded-md transition-colors ${isGenerating || !selectedProvider || !selectedModel ? "bg-gray-600 cursor-not-allowed" : "bg-purple-600 hover:bg-purple-700 active:bg-purple-800"}`}
