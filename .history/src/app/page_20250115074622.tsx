  ...
  const generateLyrics = async () => {
    ...
    try {
      ...
      for (const section of SUNO_SONG_STRUCTURE.sections) {
          ...
          messages: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: `You are an elite hip-hop lyricist creating lyrics for Suno AI. Use strict Suno vocal tag formatting. Always enclose lyrics in the appropriate section tag. Use parentheses () for callback/adlib vocals. Maintain complex rhyme schemes and authentic street wisdom.`,
                },
              ],
            },
            {
              ...
              content: [
                {
                  type: "text",
                  text: `${section.prompt} about "${theme}". Ensure lyrics are tagged with ${section.tag}`,
                },
              ],
            },
          ],
        ...
        const textContent =
          typeof lyricContent === "string"
            ? lyricContent
            : Array.isArray(lyricContent)
            ? lyricContent.find((c) => c.type === "text")?.text || ""
            : "";
        fullLyrics += `\n${section.tag}\n${textContent}\n`;
      }
