...
const SUNO_SONG_STRUCTURE = {
  sections: [
    { tag: "[Intro]", prompt: "Generate an intro that sets the tone" },
    { tag: "[Verse]", prompt: "Generate the first verse" },
    { tag: "[Pre-Chorus]", prompt: "Build tension before the chorus" },
    ...
    { tag: "[Chorus]", prompt: "Return to the chorus with more intensity" },
    { tag: "[Outro]", prompt: "Create a powerful ending" },
  ],
};
